...
Your four choices are [Neovim](https://neovim.org)(my choice), [zed](https://zed.dev) (unironically the best choice), [Emacs](https://emacs.org) (if you want to learn another programming language), and [VS Code](https://code.visualstudio.com/) (this is the one that is most used in professional circles).
